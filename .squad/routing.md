# CFP Compass — Routing Rules

## Default Routing

| Signal | Route To |
|--------|----------|
| Architecture, system design, scope decisions, ADRs | Dallas |
| .NET / C# implementation, APIs, data access, services, auth | Ripley |
| Web UI, Razor / Blazor, frontend components, forms, styling | Lambert |
...
| Keywords | Agent |
|----------|-------|
| API, endpoint, controller, service, repository, EF Core, database, auth, identity, B2C | Ripley |
| page, component, form, UI, CSS, layout, navigation, Blazor, Razor Pages, client | Lambert |
